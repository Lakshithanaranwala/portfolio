...
const EmailLink = styled(Link)`
  ...
  font-size: clamp(2.75rem, 8.5vw, 10rem);
  font-weight: 300;
...
const UnderlineTrack = styled.div`
  width: 100%;
  height: 2px;
  margin-top: 0.75rem;
  overflow: hidden;
...
const UnderlineFill = styled.div<{ $active: boolean }>`
  width: 100%;
  height: 100%;
...
export default function Footer() {
  ...
  return (
    <FooterEl>
      ...
      >
        <EmailLink href="/contact">Lakshithaux@gmail.com</EmailLink>
        <UnderlineTrack>
          <UnderlineFill $active={hovered} />
        </UnderlineTrack>
      </EmailWrapper>
